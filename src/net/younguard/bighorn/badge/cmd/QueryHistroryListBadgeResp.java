...
public class QueryHistroryListBadgeResp
		extends ResponseCommand
{
	...
	@Override
	public QueryHistroryListBadgeResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public QueryHistroryListBadgeResp()
	{
		this.setTag(CommandTag.QUERY_HISTORY_LIST_BADGE_NUMBER_RESPONSE);
	}

	public QueryHistroryListBadgeResp(int sequence)
	{
		this();
	...
	public QueryHistroryListBadgeResp(int sequence, short state)
	{
		this(sequence);
	...
	public QueryHistroryListBadgeResp(int sequence, short state, List<ListBadgeNumber> badges)
	{
		this(sequence, state);
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryHistroryListBadgeResp.class);
