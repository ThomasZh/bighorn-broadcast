...
public class QueryInviteListBadgeReq
		extends RequestCommand
{
	...
	@Override
	public QueryInviteListBadgeReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public QueryInviteListBadgeReq()
	{
		this.setTag(CommandTag.QUERY_INVITE_LIST_BADGE_NUMBER_REQUEST);
	}

	public QueryInviteListBadgeReq(int sequence)
	{
		this();
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryInviteListBadgeReq.class);
