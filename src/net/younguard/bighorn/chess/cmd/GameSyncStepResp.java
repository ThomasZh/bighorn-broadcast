		...
		extends ResponseCommand
{
	...
	@Override
	public GameSyncStepResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public GameSyncStepResp()
	{
		this.setTag(CommandTag.GAME_SYNC_STEP_RESPONSE);
	}

	public GameSyncStepResp(int sequence)
	{
		this();
	...
	public GameSyncStepResp(int sequence, short state)
	{
		this(sequence);
	...
	public GameSyncStepResp(int sequence, short state, String gameId, List<GameStep> steps)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(GameSyncStepResp.class);
