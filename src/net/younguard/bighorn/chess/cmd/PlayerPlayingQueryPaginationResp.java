...
public class PlayerPlayingQueryPaginationResp
		extends QueryPaginationResp
{
	...
	@Override
	public PlayerPlayingQueryPaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public PlayerPlayingQueryPaginationResp()
	{
		this.setTag(CommandTag.GAME_PLAYER_PLAYING_QUERY_PAGINATION_RESPONSE);
	}

	public PlayerPlayingQueryPaginationResp(int sequence)
	{
		this();
	...
	public PlayerPlayingQueryPaginationResp(int sequence, short state)
	{
		this(sequence);
	...
	public PlayerPlayingQueryPaginationResp(int sequence, short state, List<GameMasterInfo> games)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(PlayerPlayingQueryPaginationResp.class);
}
