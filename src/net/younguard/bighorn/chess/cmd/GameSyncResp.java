		...
		extends ResponseCommand
{
	...
	@Override
	public GameSyncResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public GameSyncResp()
	{
		this.setTag(CommandTag.GAME_SYNC_RESPONSE);
	}

	public GameSyncResp(int sequence)
	{
		this();
	...
	public GameSyncResp(int sequence, short state)
	{
		this(sequence);
	...
	public GameSyncResp(int sequence, short state, String gameId, List<GameStep> steps)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(GameSyncResp.class);
