...
public class GamePlayingQueryPaginationResp
		extends QueryPaginationResp
{
	...
	@Override
	public GamePlayingQueryPaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public GamePlayingQueryPaginationResp()
	{
		this.setTag(CommandTag.GAME_PLAYING_QUERY_PAGINATION_RESPONSE);
	}

	public GamePlayingQueryPaginationResp(int sequence)
	{
		this();
	...
	public GamePlayingQueryPaginationResp(int sequence, short state)
	{
		this(sequence);
	...
	public GamePlayingQueryPaginationResp(int sequence, short state, List<GameMasterInfo> games)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(GamePlayingQueryPaginationResp.class);
}
