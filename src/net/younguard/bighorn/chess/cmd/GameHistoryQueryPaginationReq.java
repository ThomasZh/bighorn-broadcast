...
public class GameHistoryQueryPaginationReq
		extends QueryPaginationReq
{
	...
	@Override
	public GameHistoryQueryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public GameHistoryQueryPaginationReq()
	{
		this.setTag(CommandTag.GAME_HISTORY_QUERY_PAGINATION_REQUEST);
	}

	public GameHistoryQueryPaginationReq(int sequence)
	{
		this();
	...
	public GameHistoryQueryPaginationReq(int sequence, short pageNum, short pageSize)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(GameHistoryQueryPaginationReq.class);
