		...
		extends ResponseCommand
{
	...
	@Override
	public GameResignNotify decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public GameResignNotify()
	{
		this.setTag(CommandTag.GAME_RESIGN_NOTIFY);
	}

	public GameResignNotify(int sequence)
	{
		this();
	...
	public GameResignNotify(int sequence, String gameId, String playerId)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(GameResignNotify.class);
