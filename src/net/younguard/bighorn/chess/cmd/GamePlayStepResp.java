		...
		extends ResponseCommand
{
	...
	@Override
	public GamePlayStepResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public GamePlayStepResp()
	{
		this.setTag(CommandTag.GAME_PLAY_STEP_RESPONSE);
	}

	public GamePlayStepResp(int sequence)
	{
		this();
	...
	public GamePlayStepResp(int sequence, short state)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(GamePlayStepResp.class);
