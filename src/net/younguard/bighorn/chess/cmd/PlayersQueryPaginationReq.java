...
public class PlayersQueryPaginationReq
		extends QueryPaginationReq
{
	...
	@Override
	public PlayersQueryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public PlayersQueryPaginationReq()
	{
		this.setTag(CommandTag.GAME_PLAYERS_QUERY_PAGINATION_REQUEST);
	}

	public PlayersQueryPaginationReq(int sequence)
	{
		this();
	...
	public PlayersQueryPaginationReq(int sequence, short pageNum, short pageSize)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(PlayersQueryPaginationReq.class);
