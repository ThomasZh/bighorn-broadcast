...
public class MyPlayingQueryPaginationReq
		extends QueryPaginationReq
{
	...
	@Override
	public MyPlayingQueryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public MyPlayingQueryPaginationReq()
	{
		this.setTag(CommandTag.GAME_MY_PLAYING_QUERY_PAGINATION_REQUEST);
	}

	public MyPlayingQueryPaginationReq(int sequence)
	{
		this();
	...
	public MyPlayingQueryPaginationReq(int sequence, short pageNum, short pageSize)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(MyPlayingQueryPaginationReq.class);
