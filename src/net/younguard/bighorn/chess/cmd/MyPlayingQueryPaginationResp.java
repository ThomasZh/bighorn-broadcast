...
public class MyPlayingQueryPaginationResp
		extends QueryPaginationResp
{
	...
	@Override
	public MyPlayingQueryPaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public MyPlayingQueryPaginationResp()
	{
		this.setTag(CommandTag.GAME_MY_PLAYING_QUERY_PAGINATION_RESPONSE);
	}

	public MyPlayingQueryPaginationResp(int sequence)
	{
		this();
	...
	public MyPlayingQueryPaginationResp(int sequence, short state)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(MyPlayingQueryPaginationResp.class);
}
