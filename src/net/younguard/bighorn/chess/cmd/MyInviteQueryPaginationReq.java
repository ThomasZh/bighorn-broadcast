...
public class MyInviteQueryPaginationReq
		extends QueryPaginationReq
{
	...
	@Override
	public MyInviteQueryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public MyInviteQueryPaginationReq()
	{
		this.setTag(CommandTag.GAME_MY_INVITE_QUERY_PAGINATION_REQUEST);
	}

	public MyInviteQueryPaginationReq(int sequence)
	{
		this();
	...
	public MyInviteQueryPaginationReq(int sequence, short pageNum, short pageSize)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(MyInviteQueryPaginationReq.class);
