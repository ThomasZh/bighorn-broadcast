...
public class MyHistoryQueryPaginationReq
		extends QueryPaginationReq
{
	...
	@Override
	public MyHistoryQueryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public MyHistoryQueryPaginationReq()
	{
		this.setTag(CommandTag.GAME_MY_HISTORY_QUERY_PAGINATION_REQUEST);
	}

	public MyHistoryQueryPaginationReq(int sequence)
	{
		this();
	...
	public MyHistoryQueryPaginationReq(int sequence, short pageNum, short pageSize)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(MyHistoryQueryPaginationReq.class);
