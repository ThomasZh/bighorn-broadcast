...
public class PlayerHistoryQueryPaginationReq
		extends QueryPaginationReq
{
	...
	@Override
	public PlayerHistoryQueryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	public PlayerHistoryQueryPaginationReq()
	{
		this.setTag(CommandTag.GAME_PLAYER_HISTORY_QUERY_PAGINATION_REQUEST);
	}

	public PlayerHistoryQueryPaginationReq(int sequence)
	{
		this();
	...
	public PlayerHistoryQueryPaginationReq(int sequence, short pageNum, short pageSize, String playerId)
	{
		this(sequence);
	...
	private final static Logger logger = LoggerFactory.getLogger(PlayerHistoryQueryPaginationReq.class);
